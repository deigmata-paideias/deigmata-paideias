...
type Data struct {
	...
	//	}
	Database      *Data_Database `protobuf:"bytes,1,opt,name=database,proto3" json:"database,omitempty"` //  Redis redis = 2;
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_conf_proto_rawDesc = "" +
	...
	"\bDatabase\x12\x10\n" +
	"\x03dsn\x18\x01 \x01(\tR\x03dsnB#Z!kratos-example/internal/conf;confb\x06proto3"
